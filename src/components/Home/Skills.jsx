            ...
            skills: [
                {
                    name: 'HTML',
                    level: 95,
                    icon: <img src={htmlIcon} alt="React" className="w-8 h-8" />,
                    years: '3+',
                    desc: 'HTML 5 '
                },

                {
                    name: 'CSS',
                    level: 95,
                    icon: <img src={cssIcon} alt="React" className="w-8 h-8" />,
                    years: '3+',
                    desc: 'CSS 3 '
                },

                {
                    name: 'JavaScript ES6+',
                    level: 95,
                    icon: <img src={jsIcon} alt="React" className="m-3 w-8 h-8" />,
                    years: '3+',
...

                {
                    name: 'Tailwind CSS',
                    level: 92,
                    icon: <img src={tailIcon} alt="Tailwind CSS" className="w-8 h-8" />,
                    years: '2+',
...

                {
                    name: 'React',
                    level: 95,
                    icon: <img src={reactIcon} alt="React" className="w-8 h-8" />,
                    years: '3+',
...

                {
                    name: 'Angular.js',
                    level: 85,
                    icon: <img src={angularIcon} alt="Vue.js" className="w-8 h-8" />,
                    years: '2+',
...

                {
                    name: 'WordPress',
                    level: 85,
                    icon: <img src={wordIcon} alt="Vue.js" className="w-8 h-8" />,
                    years: '2+',
                    desc: 'Progressive framework'
                },

                {
                    name: 'Laravel',
                    level: 85,
                    icon: <img src={LaravelIcon} alt="Vue.js" className="w-8 h-8" />,
                    years: '2+',
                    desc: 'Progressive framework'
                },
            ...
            skills: [
                {
                    name: 'Node.js',
                    level: 90,
                    icon: <img src={nodeIcon} alt="Node.js" className="w-8 h-8" />,
                    years: '3+',
                ...
                },
                {
                    name: 'Php',
                    level: 85,
                    icon: <img src={phpIcon} alt="Python" className="w-8 h-8" />,
                    years: '2+',
                ...
                },
                {
                    name: 'Express.js',
                    level: 88,
                    icon: <img src={exIcon} alt="Express.js" className="w-8 h-8" />,
                    years: '3+',
                    desc: 'Fast web framework'
                },
                {
                    name: 'MongoDB',
                    level: 82,
                    icon: <img src={mongoIcon} alt="MongoDB" className="w-8 h-8" />,
                    years: '2+',
                    desc: 'NoSQL database'
                },
                {
                    name: 'MySql',
                    level: 80,
                    icon: <img src={sqlIcon} alt="PostgreSQL" className="w-8 h-8" />,
                    years: '2+',
            ...
            skills: [
                {
                    name: 'React Native',
                    level: 88,
                    icon: <img src={rnIcon} alt="React Native" className="w-8 h-8" />,
                    years: '2+',
...

                {
                    ...
                    level: 75,
                    icon: <img src={appleIcon} alt="iOS" className="w-8 h-8" />,
                    years: '1+',
                ...
                },
                {
                    ...
                    level: 78,
                    icon: <img src={androidIcon} alt="Android" className="w-8 h-8" />,
                    years: '1+',
                    desc: 'Native Android apps'
                },

                {
                    name: 'Firebase',
                    level: 85,
                    icon: <img src={firebaseIcon} alt="Firebase" className="w-8 h-8" />,
                    years: '2+',
            ...
            skills: [
                {
                    name: 'Git/GitHub',
                    level: 92,
                    icon: <img src={gitIcon} alt="Git" className="w-8 h-8" />,
                    years: '3+',
                ...
                },
                {
                    name: 'Docker',
                    level: 85,
                    icon: <img src={dockIcon} alt="Docker" className="w-8 h-8" />,
                    years: '2+',
                ...
                },
                {
                    name: 'AWS',
                    level: 80,
                    icon: <img src={awsIcon} alt="AWS" className="w-8 h-8" />,
                    years: '2+',
                    desc: 'Cloud services'
                },
                {
...

                {
                    name: 'Figma',
                    level: 88,
                    icon: <img src={figmaIcon} alt="Vercel" className="w-8 h-8" />,
                    years: '2+',
                    desc: 'UI/UX Design'
                },
...

                {
                    name: 'Socket.io',
                    level: 78,
                    icon: <img src={socketIcon} alt="CI/CD" className="w-8 h-8" />,
                    years: '1+',
                    desc: 'Connection service'
                },
            ]
        }
    };

    const CircularSkillCard = ({ skill, index, categoryColor }) => (
        <div
        ...
        >
            ...
            <div className="relative w-32 h-32 rounded-full bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 hover:border-yellow-300/50 transition-all duration-500 group-hover:scale-110 group-hover:shadow-2xl shadow-yellow-300/20 flex flex-col items-center justify-center p-4 backdrop-blur-sm">
                ...
                <div className="relative z-10 text-center">
                    {/* Icon with hover animation and enhanced effects */}
            ...
            <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-500 scale-90 group-hover:scale-100">
                <div className="bg-gray-900/95 backdrop-blur-md px-4 py-3 rounded-xl border border-yellow-300/30 shadow-2xl min-w-max">
        ...
        <section className="min-h-screen bg-black text-white py-20 relative overflow-hidden">
                    ...
                    <div className="flex flex-wrap justify-center gap-12 lg:gap-16">
                        {categories[activeCategory].skills.map((skill, index) => (
                            <CircularSkillCard
                                ...
                                skill={skill}
                                index={index}
                                categoryColor={categories[activeCategory].color}
                            />
                        ))}
                    </div>
                </div>
            ...
            <style jsx>{`
                ...
                .skill-card:hover .skill-icon-wrapper img {
                    filter: drop-shadow(0 0 12px rgba(252, 211, 77, 0.6)) drop-shadow(0 0 24px rgba(252, 211, 77, 0.3));
                }
